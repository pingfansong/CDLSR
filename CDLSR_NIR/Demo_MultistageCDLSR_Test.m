...
% guidance modality.
% 
% The codes reproduce experiments in Section V.B 1).
...
% parameters
	...
	CDLname = 'CDL_NR_Noise0_Scale4.mat';
	load( CDLname );
	...
	ImgeNum = 2; % number of testing images to be loaded
...
% 	SIZE = ['_D',num2str(N),'x',num2str(K)];
	...
	save([FILENAME,'.mat'], 'paramsCSR', 'outputCSR_Cell', 'outputCSRsum_Cell', 't1', 't2', 't3');
