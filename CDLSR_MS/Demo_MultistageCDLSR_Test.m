...
% Specifically, given a modality, e.g. multispectral images, of low-resolution and a
% guidance modality, e.g. RGB images, of high-resolution, the algorithm
% enhances the low-resolution target modality with the aid of high-resolution
% guidance modality.
% 
...
% parameters
	...
	% load dictionaries.
	CDLname = 'CDL_D64x1024_Scale4_Date29-Apr-2018.mat';
	load( CDLname );
...
%% generate image pathes and load images
	directoryX = '../data/TestImages_Multispectral'; 
	directoryY = '../data/TestImages_Multispectral';
	patternX = '*.png';
	patternY = '*.bmp';
